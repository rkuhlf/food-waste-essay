  ...
  return (
    <>
        ...
        <main>
          ...
          <Paragraph>With food waste increasing and climate crisis becoming more threatening day by day, we must do our part as consumers to reduce waste. Small changes in our habits, from storing bread in the freezer to keeping a paper towel with your leftover lettuce to absorb excess moisture can have a relatively large effect in the aggregate (and it will save you money!). Tips and tricks for saving food are widely available (try <a target="_blank" href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/10-ways-to-cut-your-food-waste">here</a>, <a target="_blank" href="https://newsletters.wbur.org/?view_newsletter=859f940010f1d13ca2a78975875220b8&id=4004&utm_source=WBUR+Editorial+Newsletters&utm_campaign=671201ddbf-Cooked_6&utm_medium=email&utm_term=0_d0781a0a0c-671201ddbf-136910351">here</a>, or <a target="_blank" href="https://www.nytimes.com/wirecutter/guides/how-to-reduce-food-waste/">here</a>), the missing piece is a culture shift towards being cognizant of the impact we have on the Earth, and of doing more with less.</Paragraph>


          <Paragraph>Part of that shift is to reduce overeating. Americans currently consume around 3,540 calories per day<Cite index={citationIndex++}/>, more than 50% higher than the recommended 2000-2300. Counting those excess calories as waste on top of the 1200 calories explicitly thrown out, our daily food waste more than doubles, reaching 2590 calories - more than we were even supposed to eat in the first place!</Paragraph>
          ...
          <Paragraph>There is a catch though: Pasture-raised animals require a <i>massive</i> amount of land. On one acre of land, you can raise about one cow<Cite index={citationIndex++}/>, which gives you about 54,000 grams of protein after two years<Cite index={citationIndex++}/> (cattle actually grow slower on grass compared to grain). Or, you could grow 513,000 grams of protein on the same area of land from soybeans, nearly twenty times as much protein per year. Although it varies widely from case to case, animals typically represent either an inefficient energy source, a substantial land investment, or both.</Paragraph>

          <Paragraph>Aside from the destruction of habitat that is required to produce animals, the animals themselves also cause a large amount of damage to the environment because of the greenhouse gasses that their production emits. Cows famously produce a large amount of methane, but these emissions end up being negligible relative to the additional emissions required to process and transport the animals. All totaled, beef and lamb emit the equivalent of ~247 grams of CO2 for every calorie produced. Chickens, fish, and pork are much less destructive, but they are still more damaging to the environment than something like tofu (which is produced from soybeans, which are a cereal crop)<Cite index={citationIndex++}/>.</Paragraph>

          <Paragraph>In spite of the inefficiencies associated with beef, and to a lesser degree, chicken consumption, large quantities of these meats are still consumed annually. The average American eats around 57 lbs of beef each year<Cite index={citationIndex++}/> and 98 pounds of chicken<Cite index={citationIndex++}/>, resulting in almost double the meat intake compared to the 1940s<Cite index={citationIndex++}/> and destroying the planet along the way. If every single American were to go vegan, the amount of CO2 emitted by the average diet annually would decrease by more than a ton<Cite index={citationIndex++}/>, decreasing the emissions of the entire country by 7%. The power to improve the health of the planet is in the hands of the everyday person - it just seems that we haven't had the collective willpower to make that choice yet. We are the ones who have to change in order to prevent global catastrophe.</Paragraph>
